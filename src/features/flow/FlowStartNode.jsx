    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5">
          ...
          <input
            type="text"
            className="nodrag w-full outline-none text-sm bg-transparent placeholder:text-gray-400 border-t border-gray-200 pt-2"
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5">
          ...
          <input
            ...
            className="nodrag w-full text-sm px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
            value={data.regex || ""}
