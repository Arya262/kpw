       ...
       <div className="p-6">
        ...
        <div className="space-y-3 mb-6">
         <div className="flex justify-between items-center">
          ...
          <p className="text-xs text-gray-500 italic">*Prices are excluding 18% GST</p>
         </div>
         ...
         <div className="border border-gray-300 rounded-lg overflow-hidden">
          ...
          { categories.map(({ name, price  }, index) => {
           ...
           return (
            ...
            >
             <span className="w-1/3 font-medium text-gray-800 flex gap-1 items-center">{ name }</span>
         ...
         <div className="flex">
          ...
          <div className="ml-3">
           <p className="text-sm text-yellow-700">
            Your recharge balance can
            be used across all categories in WhatsApp.
           </p>
          </div>
         </div>
        </div>
