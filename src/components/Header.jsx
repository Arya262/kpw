...
import { FaSearch, FaKey, FaPowerOff, FaUser, FaCrown } from "react-icons/fa";
      ...
      <header className="sticky top-0 z-50 flex justify-between items-center px-4 py-4 shadow-md bg-white relative gap-y-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-nowrap w-auto max-w-full">
          <div
            ...
            <div className="text-sm text-gray-700 italic font-medium whitespace-nowrap hidden sm:block">
              WhatsApp Number:
            </div>

            <input
              type="text"
              value={wabaInfo?.phone || ""}
              ...
              {showUserMenu && (
                <div
                  ...
                  <div className="w-full flex flex-col gap-1">
                    ...
                    >
                      <span>Profile</span>
                      <FaUser className="ml-2 text-lg text-gray-400" />
                    </button>
                    ...
                    <Link to="/subscription" className="flex items-center justify-between px-4 py-2 text-gray-700 hover:bg-gray-100 rounded transition cursor-pointer">
                      <span>Subscription</span>
                      <FaCrown className="ml-2 text-lg text-yellow-500" />
                    </Link>
